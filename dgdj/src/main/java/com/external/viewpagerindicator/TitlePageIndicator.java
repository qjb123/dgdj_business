...
/**
 * A TitlePageIndicator is a PageIndicator which displays the title of a2_menu view
...
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (curPageBound.left < leftClip) {
            //Try to clip to the screen (a2_menu side)
        ...
        if (mCurrentPage > 0) {
            for (int i = mCurrentPage - 1; i >= 0; i--) {
                ...
                //Is a2_menu side is outside the screen
        ...
        if (mCurrentPage < countMinusOne) {
            for (int i = mCurrentPage + 1 ; i < count; i++) {
                ...
                if (bound.right > rightClip) {
                    ...
                    //Except if there's an intersection with the a2_menu view
    ...
    /**
     * Set bounds for the a2_menu textView including clip padding.
     *
     * @param curViewBound
     *            current bounds.
     * @param curViewWidth
