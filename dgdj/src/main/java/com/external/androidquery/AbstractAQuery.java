...
import com.external.androidquery.callback.*;
...
public abstract class AbstractAQuery<T extends AbstractAQuery<T>> implements Constants {
	 ...
	 * 
	 * {@link #shouldDelay(int position, android.view.View convertView, android.view.ViewGroup parent, String url)}
	 */
