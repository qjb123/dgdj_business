...
import com.bigkoo.pickerview.utils.AutofitHelper;
...
//                    float textSize = AutofitHelper.getAutofitTextSize(contentText, paintCenterText, measuredWidth/3, 1, itemHeight / 4.0f * 3, itemHeight, AutofitHelper.DEFAULT_PRECISION, getContext().getResources().getDisplayMetrics());
//                    paintCenterText.setTextSize(textSize);
                    canvas.drawText(contentText, drawCenterContentStart, maxTextHeight - CENTERCONTENTOFFSET, paintCenterText);
